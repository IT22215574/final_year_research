...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    // Direct call, avoid inline dependency array issues
    fetchUsers();
    ...
    <>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">
          {isLoading ? "Refreshing..." : `Overview (${totalUsers.toLocaleString()} total users)`}
        </p>
      </div>
      ...
      <section className="mt-6 bg-white rounded-2xl shadow-xl p-6">
        ...
        {selectedCard === "revenue" ? (
          ...
          <div className="space-y-3">
            ...
            {selectedCard === "newSignups" && newSignups7d === 0 && (
