...
// Note: Most icon assets are missing from the assets/icons directory
// Only burgermenu.png exists. Icons are commented out to prevent bundling errors.
// Consider using Expo vector icons as alternatives.
...
export const images = {
  // All image assets are missing - commented out to prevent bundling errors
};

export const icons = {
  burgermenu, // Only this icon file exists
  // All other icons are commented out as the files are missing
  // Consider using @expo/vector-icons as alternatives:
