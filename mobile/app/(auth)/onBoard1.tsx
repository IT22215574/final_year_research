          ...
          <Animated.View style={[styles.contentWrapper, contentTransform]}>
            ...
            <View style={styles.textContainer}>
              {/* Gradient Text for "Join Live Classes" */}
                ...
                maskElement={
                  <View style={styles.maskElement}>
                    <Text style={styles.gradientTitleMask}>AI Quality Grading</Text>
                  </View>
                }
              >
                <LinearGradient
              ...
              <Text style={styles.description}>
                Grade Smarter, Earn Better{"\n"}
                Our AI instantly analyzes your catch quality, helping you get premium prices for premium fish
              </Text>
              {/* Dots Indicator */}
