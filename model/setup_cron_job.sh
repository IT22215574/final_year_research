...
echo -e "  ${GREEN}•${NC} SST:         $SCRIPT_DIR/sst_data/"
echo -e "  ${GREEN}•${NC} Chlorophyll: $SCRIPT_DIR/chlorophyll_data/"
echo -e "  ${GREEN}•${NC} Currents:    $SCRIPT_DIR/ocean_currents/"
echo -e "  ${GREEN}•${NC} Bathymetry:  $SCRIPT_DIR/bathymetry_data/"
echo ""
